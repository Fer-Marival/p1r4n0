					...
					<a href="/colecciones/summer">
						<div class="collection one">
							<div class="gradient">
								...
								<a href="/colecciones/summer" class="btn btn-border">Conoce más</a>
							</div class="gradient">
						</div>
					</a>
				</div>
				<div class="col-md-4">
					<div class="collection two">
						...
						<div class="gradient">
							...
							<div class="clearfix">
								<a href="/colecciones/vista" class="btn btn-border">Conoce más</a>
							</div>
						</div>
						</a>
					</div>
					...
					<div class="collection three">
						<a href="/colecciones/kids">
							<div class="gradient">
								...
								<div class="clearfix">
									<a href="/colecciones/kids" class="btn btn-border">Conoce más</a>
								</div>
							</div>
						</a>
					</div>
		...
		<div id="team">
			<div class="row  align-items-center">
				...
				<div class="col-12 col-md-6">
					...
					<a href="/pirano" class="btn-right btn-border"><span>&#x02992;</span></a>
					</div>					
				</div>
			</div>
		</div>
